...
public class GameController extends Scene {
    ...
    public GameController(GUI gui, DatabaseController databaseController, WindowController WC, DiceController DC,
        ...
        gameModel = new GameModel(databaseController.getGameQueries(), DC.getDiceOnTableModel(), WC);
        ...
        GameInfoScreen gameInfo = new GameInfoScreen(gui, gameModel, "GameInfo");
        ChatScreen chat = CC.getChatScreen();
    ...
    /**
     * set score for client player (with private card)
     */
    ...
    /**
     * set score for player that aren't the client player (without private card)
     */
